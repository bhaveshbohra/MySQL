...
CREATE TABLE worker_clone LIKE worker; -- create a table in same database with working _clone 
...
select * from worker order by salary desc LIMIT 4,1; -- n-1,1 start at n-1
